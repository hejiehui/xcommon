...
//                        directory.add(file);
    ...
    public VirtualFile selectTargetDirectory(Project project, String defaultPackage) {
        if(defaultPackage == null) {
            ...
            VirtualFile[] selectedElements = fileEditorManager.getSelectedFiles();
            if (selectedElements != null && selectedElements.length > 0) {
                VirtualFile selectedFile = selectedElements[0];
                ...
                if (psiFile instanceof PsiJavaFile) {
                    ...
                    // 如果是目录，获取其包名
                    PsiDirectory psiDirectory = psiManager.findDirectory(selectedFile);
