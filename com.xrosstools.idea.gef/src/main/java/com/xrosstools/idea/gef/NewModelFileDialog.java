...
public class NewModelFileDialog extends DialogWrapper {
    ...
    private final boolean supportGenerateModel;
    ...
    public NewModelFileDialog(Project project,
        ...
        this.supportGenerateModel = supportGenerateModel;
    ...
    protected JComponent createCenterPanel() {
        ...
        gbc.gridy = 0;
        gbc.weightx = 0;
        inputPanel.add(new JLabel(supportGenerateModel ? "Name:" : ""), gbc);
